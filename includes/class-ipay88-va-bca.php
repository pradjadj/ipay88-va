...
class WC_Gateway_iPay88_VA_BCA extends WC_Gateway_iPay88_VA_Base {

    public $payment_id = 140;
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type'        => 'checkbox',
                'label'       => __( 'Enable iPay88 BCA VA', 'ipay88-va' ),
                'default'     => 'no',
            ),
            'title' => array(
            ...
            'description' => array(
                ...
                'default'     => 'Pay using BCA Virtual Account via iPay88.',
                'desc_tip'    => true,
            ),
            'merchant_code' => array(

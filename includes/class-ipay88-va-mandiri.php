...
class WC_Gateway_iPay88_VA_Mandiri extends WC_Gateway_iPay88_VA_Base {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type'        => 'checkbox',
                'label'       => __( 'Enable iPay88 Mandiri VA', 'ipay88-va' ),
                'default'     => 'no',
            ),
            'title' => array(
            ...
            'description' => array(
                ...
                'default'     => 'Pay using Mandiri Virtual Account via iPay88.',
                'desc_tip'    => true,
            ),
            'merchant_code' => array(
